...
const Layout = () => {
  ...
  return (
    <div className="">
      ...
      <div className="p-[36px_16px] flex w-[250px]  bg-[#1C2536] gap-[110px]">
        <div className="flex flex-col gap-[8px]  h-screen self-stretch items-start">
          <Link
          ...
          <Link to={"other"} className=" w-[218px] rounded-[4px] p-[10px_16px] text-[#FFF] focus:bg-[#FFF] focus:text-[#5A607F]">
            <div className="flex items-center gap-[16px]">
              <FolderOpenIcon />
