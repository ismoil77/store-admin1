        ...
        <>
            <div className="flex flex-col justify-center m-auto mt-[2%]">
                ...
                <div className=" m-auto  mt-[5%] ">
                    <div className="w-[150%] shadow-xl rounded-[5px] mt-[5%] p-[20px] border">
                    ...
                    <div className="w-[150%] shadow-xl rounded-[10px] p-[10px] border mt-[5%] ">
                    ...
                    <div className="w-[150%] shadow-xl rounded-[5px] mt-[5%] py-[5px] border">
