...
const AddProducts = () => {
    ...
    return (
        <div className="flex flex-col gap-[24px] p-[28px]">
            <div className="flex items-center gap-[500px] justify-between">
                ...
                <div className="flex gap-[12px] items-center">
                    ...
                    <Button onClick={() => { dispatch(postProduct(product)) }} variant="contained">Save</Button>
                </div>
            </div>
            <section className="flex gap-[40px] items-start">
                <div className="flex flex-col gap-[40px] items-start">
                    ...
                    <div className="flex flex-col gap-[16px] items-start pb-[20px]">
                        <h1 className="text-[#131523] text-[16px] font-[700]">Price</h1>
                        <div className="flex items-start gap-[16px]">
                            <input value={product.Price} onChange={handleChange} name="Price" className='w-[32%] h-[45px] border rounded-[5px] px-[10px]' placeholder='Product price' type="number" />
                            <input value={product.DiscountPrice} onChange={handleChange} name="DiscountPrice" className='w-[32%] h-[45px] border rounded-[5px] px-[10px]' placeholder='Discount' type="number" />
                            <input value={product.Quantity} onChange={handleChange} name="Quantity" className='w-[32%] h-[45px] border rounded-[5px] px-[10px]' placeholder='Count' type="number" />
                        </div>
